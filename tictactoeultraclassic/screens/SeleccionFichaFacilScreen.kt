...
@Composable
fun SeleccionFichaFacilScreen(navController: NavHostController, onFichaSeleccionada: (String) -> Unit) {
    Box(
        modifier = Modifier
            .fillMaxSize(),
            ...
            Row {
                Button(
                    onClick = {
                        ...
                        navController.navigate("juegoFacil/X")
                    },
                ...
                Button(
                    onClick = {
                        ...
                        navController.navigate("juegoFacil/O")
                    },

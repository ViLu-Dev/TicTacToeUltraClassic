...
@Composable
fun SeleccionFichaDificilScreen(navController: NavHostController, onFichaSeleccionada: (String) -> Unit) {
    Box(
        modifier = Modifier
            .fillMaxSize(),
            ...
            Row {
                Button(
                    onClick = {
                        ...
                        navController.navigate("juegoDificil/X")
                    },
                ...
                Button(
                    onClick = {
                        ...
                        navController.navigate("juegoDificil/O")
                    },
